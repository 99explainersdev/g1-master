...
//     color: "#E0F2FE",
//     iconColor: "#0284C7",
//     tag: "Regulatory & Warning",
//     mainSignName: "Yield Sign",
//     signImage: "https://res.cloudinary.com/dcfleowsb/image/upload/v1761546299/Picture1_bzmyom.jpg",
//     description:
//       "A yield sign is a triangle pointing downward, red and white. It means you must let traffic in the intersection or close to it go first.",
//     steps: [
//       {
//         title: "Slow Down",
//         desc: "Reduce your speed as you approach the intersection.",
//       },
//       {
//         title: "Stop if Necessary",
//         desc: "Stop if necessary to avoid a collision with traffic.",
//       },
//       { title: "Proceed", desc: "Enter only when the way is clear." },
//     ],
//     commonMistake:
//       "Not slowing down enough. Many drivers treat a yield sign like a 'proceed' sign without looking for cross traffic.",
//     proTip:
//       "Always look left and right twice. Even if you have the right of way, defensive driving saves lives.",
//     legalNote:
//       "Failure to yield at a sign can result in 3 demerit points and a significant fine in Ontario.",
//   },
//   {
//     id: 2,
//     title: "Rules of Road",
...
//     iconColor: "#D97706",
//     tag: "Driving Laws",
//     mainSignName: "Right of Way",
//     signImage: "https://res.cloudinary.com/dcfleowsb/image/upload/v1761546299/Picture1_bzmyom.jpg", // Replace with actual image
//     description:
//       "Right-of-way rules help determine who goes first at intersections where there are no signs or signals.",
//     steps: [
//       {
//         title: "First to Arrive",
//         desc: "At an all-way stop, the first vehicle to arrive goes first.",
//       },
//       {
//         title: "Yield to Right",
//         desc: "If two cars arrive at the same time, the one on the left yields to the one on the right.",
//       },
//       {
//         title: "Left Turns",
//         desc: "Drivers turning left must yield to oncoming traffic going straight.",
//       },
//     ],
//     commonMistake:
//       "Assuming the other driver knows the rules. Always wait for them to signal or start moving first.",
//     proTip: "If in doubt, wave the other driver through to avoid confusion.",
//     legalNote:
//       "Intersections are the most common place for accidents; strict adherence to right-of-way is mandatory.",
//   },
//   {
//     id: 3,
//     title: "Points & Fine",
...
//     iconColor: "#16A34A",
//     tag: "Penalties",
//     mainSignName: "Speeding Fines",
//     signImage: "https://res.cloudinary.com/dcfleowsb/image/upload/v1761546299/Picture1_bzmyom.jpg", // Replace with actual image
//     description:
//       "Speeding is one of the most common traffic violations and carries heavy penalties depending on the excess speed.",
//     steps: [
//       {
//         title: "1-19 km/h over",
//         desc: "Small fine, typically 0 to 3 demerit points.",
//       },
//       {
//         title: "20-49 km/h over",
//         desc: "Heavy fines and 3 to 4 demerit points.",
//       },
//       {
//         title: "50+ km/h over",
//         desc: "Immediate license suspension and vehicle impoundment (Stunt Driving).",
//       },
//     ],
//     commonMistake:
//       "Thinking 'going with the flow' of traffic justifies speeding. The legal limit is the maximum.",
//     proTip:
//       "Set your cruise control to the speed limit to avoid accidental 'creeping' speed.",
//     legalNote:
...
//       <ScrollView contentContainerStyle={styles.detailScrollContent}>
//         {/* Sign/Main Visual Card with Image */}
//         <View style={styles.signCard}>
//           <View style={styles.signImageContainer}>
//             <Image
//               source={{ uri: selectedTopic.signImage }}
...
//         <View style={styles.contentSection}>
//           <Text style={styles.sectionHeading}>Proper Procedure</Text>
//           {selectedTopic.steps.map((step: any, idx: number) => (
//             <View key={idx} style={styles.stepRow}>
//               <View style={styles.stepNumber}>
//                 <Text style={styles.stepNumberText}>{idx + 1}</Text>
//               </View>
